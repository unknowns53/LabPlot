...
> （スクリーンショット予定: docs/user-guide/images/spectrum/10-uv-vis-loaded.png）
...
- **線スタイル**: 選択中のデータセットの色・凡例名・線幅・マーカーサイズを設定します。色は名前付きプリセット（Indigo / Crimson など）と、Custom 選択時の hex 入力 / HSV パレット（彩度×明度の四角と色相スライダー）から選べます。
...
書式設定は **「既定保存」** ボタンで `%AppData%\Spectrum_Visualization\formatting_config.json` に保存され、次回起動時に復元されます。

> （スクリーンショット予定: docs/user-guide/images/spectrum/30-formatting.png）
...
> （スクリーンショット予定: docs/user-guide/images/spectrum/17-ir-peaks.png）
...
> （スクリーンショット予定: docs/user-guide/images/spectrum/15-temperature-hysteresis.png）
...
> （スクリーンショット予定: docs/user-guide/images/spectrum/38-calibration.png）
...
> （スクリーンショット予定: docs/user-guide/images/spectrum/50-session.png）
...
> （スクリーンショット予定: docs/user-guide/images/spectrum/60-preferences.png）
